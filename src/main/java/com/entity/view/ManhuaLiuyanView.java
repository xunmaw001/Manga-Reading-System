...
public class ManhuaLiuyanView extends ManhuaLiuyanEntity implements Serializable {
	...
	public ManhuaLiuyanView() {

	}

	public ManhuaLiuyanView(ManhuaLiuyanEntity manhuaLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, manhuaLiuyanEntity);
