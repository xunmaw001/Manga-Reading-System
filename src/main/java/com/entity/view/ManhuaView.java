 ...
 */
@TableName("manhua")
public class ManhuaView extends ManhuaEntity implements Serializable {
	...
	public ManhuaView(ManhuaEntity manhuaEntity) {
		try {
			BeanUtils.copyProperties(this, manhuaEntity);
